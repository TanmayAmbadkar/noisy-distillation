...
for env in "${ENVS[@]}"; do
    ...
    echo "================================================="
    echo "Launching parallel SB3 DDPG sweep for Env: $env | Timesteps: $TIMESTEPS"
    echo "================================================="
    ...
    for i in {0..4}; do
        ...
        LOG_FILE="sweep_summaries/sb3/${env}_sb3_ddpg_seed_${SEED}_full.log"
        RES_FILE="sweep_summaries/sb3/${env}_sb3_ddpg_seed_${SEED}_final_results.txt"
        
        echo "Launching SB3 DDPG Process $((i+1)) (Seed: $SEED) on CPUs $CPU_RANGE"
        ...
        (
            ...
            echo "Finished SB3 DDPG Env: $env | Seed: $SEED"
    ...
    wait
    echo "All SB3 DDPG seeds for Env: $env completed."
    echo ""
done

echo "SB3 DDPG Sweep fully completed! All summaries are located in the 'sweep_summaries/sb3' directory."
